...
functions {
   ...
   array[] int y, // Integer array of binary response dimensions
...
data {
  ...
  array[N, D] int<lower=0, upper=1> y; // Response data for training set
  array[N] vector[K] x; // Covariate data for training set  
}
parameters {
